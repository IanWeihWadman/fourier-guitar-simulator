...
namespace TabParser
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            StreamWriter writer = new StreamWriter("C:\\Users\\annel\\source\\repos\\FourierGuitarSimulator\\" + Filename);
            string line = "";
            int lineIndex = -2;
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                for (int j = 0; j < information[i].Count; j++)
                {
                    ...
                    {
                        int nextValue = -1;
                        string[] breakdown = information[i][j].Split(" ");
            ...
            for (int i = 0; i < emphases.Count; i++)
            {
                ...
                if (emphases[i] != 0)
                {
                    ...
                    {
                        int strum = 0;
                        string[] breakdown = information[6][i].Split(" ");
            ...
            foreach (Tuple<int, int, int, int> e in fretting)
            {
                if (specialInstructions[e.Item4][e.Item1].Contains("b"))
                {
                    ...
                    for (int i = 0; i < duration; i++)
                    {
                        ...
                        {
                            int b = 0;
                            string[] breakdown = specialInstructions[e.Item4][e.Item1 + i].Split(" ");
                            for (int j = 0; j < breakdown.Length; j++)
                            {
                                if (breakdown[j] == "b")
                                {
            ...
            for (int j = 0; j < 6; j++)
            {
                for (int i = 0; i < specialInstructions[j].Count; i++)
                {
                    ...
                    {
                        string[] breakdown = specialInstructions[j][i].Split(" ");
                        int a = 0;
                    ...
                    if (specialInstructions[j][i].Contains("/"))
                    {
                        ...
                        for (int k = i + 1; k < information[j].Count; k++)
                        {
                            ...
                            {
                                if (int.TryParse(information[j][k].Split(" ")[0], out p))
                                {
